...
public class ImageServiceImpl implements ImageService{
	 ...
	 * Image image = new Image(null, file.getOriginalFilename(), 
	 ...
	 @Override
	 public Image uplaodImageProd(MultipartFile file,Long idOuv) 
	 throws IOException {
	 Ouvrier o = new Ouvrier();
	 o.setIdOuvrier(idOuv);
	 return imageRepository.save(Image.builder()
	  .name(file.getOriginalFilename())
	  .type(file.getContentType())
	  .image(file.getBytes())
	 ...
	 @Override
	 public List<Image> getImagesParProd(Long ouvId) {
	 Ouvrier o = ouvrierRepository.findById(ouvId).get();
	 return o.getImages();
	 } 
